...
import com.builtbroken.baggablemobs.lib.network.PacketConfigSync;
...
public class ModConfig {
	...
	public static void init() {
		if (CONFIG == null) {
			CONFIG = new Configuration(new File(BaggableMobs.CONFIG_FILE));
			CONFIG.load();
		}
	...
	public static void sendToPlayer(EntityPlayerMP player) {
		...
		PacketHandler.getInstance().sendTo(new PacketConfigSync(configsToSend), player);
	}
